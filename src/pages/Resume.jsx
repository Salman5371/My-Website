    ...
    <section className="container" style={{ padding: "60px 0" }}>
      ...
      >
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            <li>
              ...
              American International University-Bangladesh , 2022–2026 <br />
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            <li>1️⃣ Hospital Management System</li>
            <li>2️⃣ Shop Management System</li>
            <li>3️⃣ Floor Cleaning Robot</li>
            <li>4️⃣ IoT + ML Crop Recommendation</li>
          </ul>
        </motion.div>
